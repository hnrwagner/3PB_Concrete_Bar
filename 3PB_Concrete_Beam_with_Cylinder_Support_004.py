...
def Create_BC(model,set_name,BC_name,instance_name,step_name,u,v,w,ur,vr,wr):
    a = mdb.models[model].rootAssembly
    r1 = a.instances[instance_name].referencePoints
    refPoints1=(r1[3], )
    region = a.Set(referencePoints=refPoints1, name=set_name)
...
def Create_Plot(data_1,data_2,max_data_1,max_data_2,min_data_1,min_data_2,fig_name):
    fig, ax = plt.subplots()
    ...
    plt.grid(True)
    plt.axis([min_data_1, max_data_1, min_data_2, max_data_2])
...
myPart = "Frame"
myString = "Concrete_Frame_3PB_CS_with_Damage"
mdb.Model(name=myString)
myMaterialName = "Concrete"
myJobName= "3PB_CS_Concrete_Beam_with_Damage"
...
# Create Cylinder Support 

Create_CS(myString,"Cylinder_Support",25.0,150.0)


Assembly_CS(myString,"Cylinder_Support",0.0,150/2.0+25,0.0,1)
Assembly_CS(myString,"Cylinder_Support",-225.0,-150/2.0-25,0.0,2)
Assembly_CS(myString,"Cylinder_Support",225.0,-150/2.0-25,0.0,3)

Create_Contact(myString)

# Create Boundary Conditions

# Create Loading

Create_BC(myString,"RP-1",'Support-1',"Cylinder_Support-1","Loading",SET,-myLoad,SET,SET,SET,SET)
Create_BC(myString,"Set-2",'Support-2',"Cylinder_Support-2","Initial",SET,SET,SET,SET,SET,SET)
Create_BC(myString,"Set-3",'Support-3',"Cylinder_Support-3","Initial",SET,SET,SET,SET,SET,SET)

# Create Mesh

Create_Mesh(myString,myPart,10.0)
Create_Mesh(myString,"Cylinder_Support",10.0)
...
# (data_1,data_2,max_data_1,max_data_2,min_data_1,min_data_2,fig_name):

Create_Plot(U_data,RF_data,1.44,Len_RF,1.358,0.0,'Load_Displacement_Curve_Concrete_3PB_CS.png')
